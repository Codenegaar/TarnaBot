#############################################################################
# Makefile for building: libTBFramework.so.1.0.0
# Generated by qmake (3.1) (Qt 5.9.1)
# Project:  TBFramework.pro
# Template: lib
# Command: /usr/bin/qmake -o Makefile TBFramework.pro
#############################################################################
...
INCPATH       = -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtNetwork -isystem /usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = TBFramework1.0.0
DISTDIR = /home/ali_rnt/Projects/TBTestBot/lib/TBFramework/.tmp/TBFramework1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now -shared -Wl,-soname,libTBFramework.so.1
...
SOURCES       = src/update.cpp \
		src/tbreceiver.cpp moc_tbreceiver.cpp
OBJECTS       = update.o \
		tbreceiver.o \
		moc_tbreceiver.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		TBFramework.pro include/update.h \
		include/tbreceiver.h src/update.cpp \
		src/tbreceiver.cpp
QMAKE_TARGET  = TBFramework
DESTDIR       = 
TARGET        = libTBFramework.so.1.0.0
TARGETA       = libTBFramework.a
TARGET0       = libTBFramework.so
TARGETD       = libTBFramework.so.1.0.0
TARGET1       = libTBFramework.so.1
TARGET2       = libTBFramework.so.1.0
...
Makefile: TBFramework.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile TBFramework.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/update.h include/tbreceiver.h $(DISTDIR)/
	$(COPY_FILE) --parents src/update.cpp src/tbreceiver.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_tbreceiver.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_tbreceiver.cpp
moc_tbreceiver.cpp: include/update.h \
		include/tbreceiver.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/ali_rnt/Projects/TBTestBot/lib/TBFramework -I/usr/include/qt -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/7.1.1 -I/usr/include/c++/7.1.1/x86_64-pc-linux-gnu -I/usr/include/c++/7.1.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/7.1.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/7.1.1/include-fixed -I/usr/include include/tbreceiver.h -o moc_tbreceiver.cpp
...
tbreceiver.o: src/tbreceiver.cpp include/tbreceiver.h \
		include/update.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tbreceiver.o src/tbreceiver.cpp

moc_tbreceiver.o: moc_tbreceiver.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_tbreceiver.o moc_tbreceiver.cpp
